                    ...
                    {loading ? (
                        ...
                        <form onSubmit={saveEntity}>
                            ...
                            <FormControl fullWidth>
                                <InputLabel id="consortium-segmentType-label">
                                    {translate('repasseconsorcioApp.consortium.contemplationStatus.title') + ' *'}
                                </InputLabel>
                                <Select
                                    required
                            ...
                            <DialogActions sx={{ mt: 2, px: 0 }}>
                                <Button
                                    onClick={() => setOpenConsortiumUpdateModal(false)}
