...
import userManagement, { getUsers, getUsersAsAdmin, getRoles, getUser, createUser, updateUser, deleteUser, reset } from './user-management.reducer'
...
describe('User management reducer tests', () => {
  ...
  describe('Failures', () => {
    it('should set state to failed and put an error message in errorMessage', () => {
      testMultipleTypes(
        [getUsersAsAdmin.rejected.type, getUsers.rejected.type, getUser.rejected.type, getRoles.rejected.type, createUser.rejected.type, updateUser.rejected.type, deleteUser.rejected.type],
