...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSORTIUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONSORTIUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONSORTIUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONSORTIUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONSORTIUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONSORTIUM actions', async () => {
      const expectedActions = [
        {
