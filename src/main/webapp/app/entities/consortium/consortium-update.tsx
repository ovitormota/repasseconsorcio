          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                id="consortium-consortiumValue"
                name="consortiumValue"
                data-cy="consortiumValue"
                type="text"
              />
              <ValidatedField
              ...
              <ValidatedField
                ...
                id="consortium-minimumBidValue"
                name="minimumBidValue"
                data-cy="minimumBidValue"
                type="text"
              />
              <ValidatedField
              ...
              <ValidatedField
                ...
                id="consortium-installmentValue"
              ...
              <ValidatedField
                label={translate('repasseconsorcioApp.consortium.status')}
                id="consortium-status"
                name="status"
                data-cy="status"
                type="select"
              >
              ...
              <ValidatedField
                ...
                name="userId"
                data-cy="user"
                label={translate('repasseconsorcioApp.consortium.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
