...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BID_LIST actions', async () => {
    ...
    it('dispatches FETCH_BID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BID actions', async () => {
      const expectedActions = [
        {
