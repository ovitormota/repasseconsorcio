    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {consortiumAdministratorEntity.image ? (
              <div>
                {consortiumAdministratorEntity.imageContentType ? (
                  <a onClick={openFile(consortiumAdministratorEntity.imageContentType, consortiumAdministratorEntity.image)}>
                    <Translate contentKey="entity.action.open">Open</Translate>&nbsp;
                  </a>
                ) : null}
                <span>
                  {consortiumAdministratorEntity.imageContentType}, {byteSize(consortiumAdministratorEntity.image)}
                </span>
              </div>
            ) : null}
          </dd>
