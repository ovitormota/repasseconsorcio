...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IConsortiumAdministrator, thunkAPI) => {
    const result = await axios.post<IConsortiumAdministrator>(apiUrl, cleanEntity(entity))
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IConsortiumAdministrator, thunkAPI) => {
    const result = await axios.put<IConsortiumAdministrator>(`${apiUrl}/${entity.id}`, cleanEntity(entity))
    thunkAPI.dispatch(getEntities({}))
    return result
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IConsortiumAdministrator, thunkAPI) => {
    const result = await axios.patch<IConsortiumAdministrator>(`${apiUrl}/${entity.id}`, cleanEntity(entity))
    thunkAPI.dispatch(getEntities({}))
    return result
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`
    const result = await axios.delete<IConsortiumAdministrator>(requestUrl)
    thunkAPI.dispatch(getEntities({}))
    return result
  },
  { serializeError: serializeAxiosError }
