...
export const ConsortiumAdministratorDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    props.history.push('/administradoras')
  }
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id='repasseconsorcioApp.consortiumAdministrator.delete.question'>
        <Translate contentKey='repasseconsorcioApp.consortiumAdministrator.delete.question' interpolate={{ id: consortiumAdministratorEntity.id }}>
