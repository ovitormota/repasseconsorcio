      ...
      <h2 id="consortium-administrator-heading" data-cy="ConsortiumAdministratorHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="repasseconsorcioApp.consortiumAdministrator.home.createLabel">
              Create new Consortium Administrator
            </Translate>
          </Link>
        </div>
      </h2>
          ...
          {consortiumAdministratorList && consortiumAdministratorList.length > 0 ? (
              ...
              <tbody>
                {consortiumAdministratorList.map((consortiumAdministrator, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {consortiumAdministrator.image ? (
                        <div>
                          {consortiumAdministrator.imageContentType ? (
                            <a onClick={openFile(consortiumAdministrator.imageContentType, consortiumAdministrator.image)}>
                              <Translate contentKey="entity.action.open">Open</Translate>
                              &nbsp;
                            </a>
                          ) : null}
                          <span>
                            {consortiumAdministrator.imageContentType}, {byteSize(consortiumAdministrator.image)}
                          </span>
                        </div>
                      ) : null}
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="repasseconsorcioApp.consortiumAdministrator.home.notFound">
                  No Consortium Administrators found
                </Translate>
              </div>
            )
          )}
