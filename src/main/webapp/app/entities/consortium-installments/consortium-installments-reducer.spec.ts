...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './consortium-installments.reducer'
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSORTIUMINSTALLMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONSORTIUMINSTALLMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONSORTIUMINSTALLMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONSORTIUMINSTALLMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONSORTIUMINSTALLMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONSORTIUMINSTALLMENTS actions', async () => {
      const expectedActions = [
        {
