...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './notification-token.reducer'
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONTOKEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONTOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONTOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONTOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONTOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONTOKEN actions', async () => {
      const expectedActions = [
        {
